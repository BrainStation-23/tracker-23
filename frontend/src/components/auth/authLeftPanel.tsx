  ...
  return (
    <div className=" bg-[url('/images/bg_login.svg')] bg-cover bg-no-repeat">
      <div className="relative flex h-full w-full flex-col-reverse">
        <div className="absolute right-[-8%] top-[8%] flex h-1/2 w-full justify-end 2xl:right-[-8%]">
          <Image
            alt=".."
            // preview={false}
            width={800}
        ...
        <div className=" z-10 ml-[8%] mb-[32%] flex flex-col gap-6 lg:mb-[22%] 2xl:mb-[15%]">
          ...
          <Button className="mt-12 flex w-min items-center rounded-lg bg-white py-6 px-3 font-semibold">
            Try Tracker23 Now
          </Button>
        </div>
      </div>
