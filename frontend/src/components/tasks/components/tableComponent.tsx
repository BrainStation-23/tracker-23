import { Button, Table, TablePaginationConfig, Tooltip, Typography, message } from "antd";
...
import PriorityDropdownComponent from "./priorityDropdown";
                ...
                >
                    <div
                        style={{
                            ...
                            border: `1px solid ${statusBorderColorEnum[task.statusCategoryName]}`,
                            borderRadius: "36px",
                        }}
