...
import { ForgotPasswordDto, LoginDto, LoginResponseDto, ResetPasswordDto } from "models/auth";
...
export interface apiFunction {
    ...
    updateTaskPriority: (taskId: any, data: any) => Promise<any>;
    updateTaskEstimation: (taskId: any, data: UpdateTaskEstimationParams) => Promise<any>;
