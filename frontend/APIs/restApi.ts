...
import { CreateLocalProjectModel, CreateWorkspaceModel, SearchParamsModel } from "models/apiParams";
import {
    ForgotPasswordDto,
    LoginDto,
    LoginResponseDto,
...
export async function loginRest(data: LoginDto): Promise<LoginResponseDto | undefined> {
    try {
...
export async function googleLoginRest(code: string): Promise<LoginResponseDto | undefined> {
    try {
...
export async function registerRest(data: RegisterDto): Promise<RegisterDto | undefined> {
    try {
...
export async function forgotPasswordRest(data: ForgotPasswordDto): Promise<any> {
    try {
...
export async function resetPasswordRest(token: string, data: ResetPasswordDto): Promise<any> {
    try {
        const res = await axios.patch(`${apiEndPoints.resetPassword}/${token}`, data);
        return res.data;
    } catch (error: any) {
        console.log("🚀 ~ file: restApi.ts:59 ~ error:", error);
        return null;
...
export async function getTasksRest(searchParams: SearchParamsModel) {
    console.log("🚀 ~ file: restApi.ts:135 ~ getTasksRest ~ searchParams:", searchParams);
...
export async function syncProjectTasksRest(projectId: number) {
    try {
        const res = await axios.get(`${apiEndPoints.syncProjectTasks}/${projectId}`);
        return res.data;
    } catch (error: any) {
        return false;
    }
...
export async function updateTaskSTatusRest(taskId: any, data: UpdateTaskStatusParams) {
    try {
        const res = await axios.patch(`${apiEndPoints.updateTaskStatus}/${taskId}`, {
...
export async function updateTaskPriorityRest(taskId: any, data: any) {
    try {
        const res = await axios.patch(`${apiEndPoints.updateTaskPriority}/${taskId}`, {
            status: data.status.name,
        });
        return res.data;
    } catch (error: any) {
...
export async function updateTaskEstimationRest(taskId: any, data: UpdateTaskEstimationParams) {
    try {
        const res = await axios.patch(`${apiEndPoints.updateTaskEstimation}/${taskId}`, {
...
export async function markAllNotificationsClearedRest() {
    try {
        const res = await axios.patch(`${apiEndPoints.markAllNotificationsCleared}`);
        return res.data;
    } catch (error: any) {
        return false;
    }
...
export async function updateSessionRest(sessionId: number, data: AddWorkLogParams) {
    try {
        const res = await axios.patch(`${apiEndPoints.updateSession}${sessionId}`, data);
        return res.data;
    } catch (error: any) {
        return false;
    }
...
export async function getJiraActiveSprintTasksRest(searchParams: SearchParamsModel) {
    const status = getStringFromArray(getLabels(searchParams?.status));
    const priority = getStringFromArray(searchParams?.priority);
    const projectIds = searchParams?.projectIds;
    try {
...
export async function updateWorkspaceRest(data: CreateWorkspaceModel, id: number) {
    try {
...
export async function sendWorkspaceInvitationRest(data: SendWorkspaceInviteDto) {
    try {
